...
var NextButton = function NextButton(_ref) {
  ...
  var NextBtnBlack = (0, _goober.css)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    padding: 5px 16px;\n    width: max-content;\n    height: 30px;\n    font-size: 16px;\n    background-color: ", ";\n    color: ", ";\n    text-decoration: none;\n    border-radius: 40px;\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n    z-index: 3;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    box-shadow: 1px 1px 2px rgba(0, 0, 0, 0.3),\n      inset 0px -1px 2px rgba(0, 0, 0, 0.3),\n      inset 0px 1px 2px rgba(0, 0, 0, 0.3);\n    display: flex;\n    justify-content: space-between;\n    transition: all 0.3s ease;\n\n    & span {\n      text-transform: capitalize;\n    }\n  "])), _colors.default.black, _colors.default.white);
  (0, _hooks.useEffect)(function () {
    if (lang !== '') {
      setTimeout(function () {
        setLang('');
  ...
  return (0, _preact.h)("div", null, lang ? (0, _preact.h)("div", {
    className: NextBtnBlack
  }, (0, _preact.h)("div", null, "\uD83D\uDC4F You are subscribed to ", (0, _preact.h)("span", null, lang))) : (0, _preact.h)("div", {
    onClick: clickedOnNext,
    className: NextBtn
  }, (0, _preact.h)("div", null, "Next ", (0, _preact.h)("img", {
    src: _arrow.default,
    alt: "right arrow",
    height: "14"
  }))));
...
var SelectLanguages = function SelectLanguages() {
  ...
  var _useState7 = (0, _hooks.useState)("".concat(_default2.default)),
      ...
      setVideoUrl = _useState8[1]; // const [pause, setPause] = useState(false);


  var _useState9 = (0, _hooks.useState)([]),
      _useState10 = _slicedToArray(_useState9, 2),
      allLanguagesData = _useState10[0],
      setAllLanguagesData = _useState10[1];
  ...
  var selectLanguages = function selectLanguages(langId) {
    ...
    if (subscribedLanguages.includes(langId)) {
      ...
      setVideoUrl("".concat(_default2.default));
