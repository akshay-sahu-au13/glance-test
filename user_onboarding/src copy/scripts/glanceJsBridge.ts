...
export const getAllSubscribedLanguages = (): string[] => {
  ...
  if (typeof GlanceAndroidInterface !== 'undefined') {
    ...
    return ['en', 'ta', 'te']; // comment this line later
  }
...
export const getAllLanguages = () => {
  if (typeof GlanceAndroidInterface !== 'undefined') {
    ...
    return '[{"displayName":"tamil","id":"ta","isSubscriptionModifiable":false},{"displayName":"kannada","id":"kn","isSubscriptionModifiable":false},{"displayName":"bangla","id":"bn","isSubscriptionModifiable":false},{"displayName":"telugu","id":"te","isSubscriptionModifiable":false},{"displayName":"hindi","id":"hi","isSubscriptionModifiable":false},{"displayName":"marathi","id":"mr","isSubscriptionModifiable":false},{"displayName":"english","id":"en","isSubscriptionModifiable":false}]';
  }
