...
const SelectedCategories: FunctionComponent = () => {
  ...
  return <div className={outerContainer}>
    <div className={summaryContainer}>
      ...
      <CategoryChoices bgImg={newsImg} bgColor={`${colors.black3}`} isSelected={categories['#news']} catg={'#news'} name={'National News'} depth={'30%'} setCategories={setCategories} categories={categories} startTime={startTime} />
