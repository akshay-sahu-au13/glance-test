...
const SelectedCategories: FunctionComponent = () => {
  ...
  return <div className={summaryContainer}>
    ...
    <CategoryChoices bgImg={sportsImg} bgColor={`${colors.black4}`} isSelected={categories['#sports']} catg={'#sports'} name={'Sports'} depth={'-45%'} setCategories={setCategories} categories={categories} startTime={startTime} />
    <CategoryChoices bgImg={''} bgColor={`${colors.pink}`} isSelected={false} catg={''} depth={'-60%'} setCategories={setCategories} categories={categories} name={''} startTime={startTime} />
  </div>
}
